...
public class UserMenuController {
    ...
    public String handleRequest(@RequestParam String action, Model model, HttpServletRequest request) {
        ...
        List<Map<String, Object>> balanceData = getBalanceData();
    ...
    private List<Map<String, Object>> getBalanceData() {
        String sql = "SELECT * FROM BALANCE";
        List<Map<String, Object>> balanceData = jdbcTemplate.queryForList(sql);
        return balanceData;
    }
